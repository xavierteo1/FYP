...
--
-- Host: 127.0.0.1    Database: clothes_swap
-- Database schema for railway
--
...
--
-- Table structure for table `ootd_posts`
--
...
--
-- Table structure for table `ootd_likes`
--
...
--
-- Table structure for table `ootd_comments`
--
...
--
-- Table structure for table `ootd_notifications`
--
...
--
-- Table structure for table `swap_swipes`
--
...
--
-- Table structure for table `swap_matches`
--
...
CREATE TABLE `swap_matches` (
  ...
  `user1_item_id` int NOT NULL,
  `user2_item_id` int NOT NULL,
  ...
  KEY `sm_u1_i1_fk` (`user1_item_id`),
  KEY `sm_u2_i2_fk` (`user2_item_id`),
  ...
  CONSTRAINT `sm_u1_i1_fk` FOREIGN KEY (`user1_item_id`) REFERENCES `clothing_items` (`item_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `sm_u2_fk` FOREIGN KEY (`user2_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `sm_u2_i2_fk` FOREIGN KEY (`user2_item_id`) REFERENCES `clothing_items` (`item_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `swap_payments`
--
...
--
-- Table structure for table `swap_payment_stepups`
--
...
--
-- Table structure for table `swap_refunds`
--
...
--
-- Table structure for table `swap_confirmations`
--
...
CREATE TABLE `swap_confirmations` (
  ...
  KEY `sc_responded_by_fk` (`responded_by_user_id`),
  ...
  CONSTRAINT `sc_responded_by_fk` FOREIGN KEY (`responded_by_user_id`) REFERENCES `users` (`user_id`) ON DELETE SET NULL ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `swap_cases`
--
...
--
-- Table structure for table `swap_delivery_addresses`
--
...
--
-- Table structure for table `sahm_applications`
--
...
--
-- Table structure for table `sahm_profiles`
--
...
--
-- Table structure for table `sahm_availability`
--
...
--
-- Table structure for table `pickup_delivery_requests`
--
...
--
-- Table structure for table `sahm_payout_requests`
--
...
--
-- Table structure for table `review_tags_master`
--
...
--
-- Table structure for table `user_review_tags`
--
...
--
-- Table structure for table `style_recommendations`
--
